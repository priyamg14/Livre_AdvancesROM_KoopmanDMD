...
Notebooks
- `Extended_DMD.ipynb` — EDMD pipeline: construct observables, compute Koopman operator via DMD/EDMD, reconstruct data, and compare analytical eigenvalues with data-driven eigenvalues.
